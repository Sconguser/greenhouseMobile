...
class NavigationNotifier extends _$NavigationNotifier {
  ...
  int _calculateSelectedIndex(GoRouter router) {
    ...
    if (location.startsWith(AppRoutes.plants.path)) return 2;
    if (location.startsWith(AppRoutes.settings.path)) return 3;
    return 0;
  }
  ...
  void navigate(int index) {
    ...
    final path = switch (index) {
      ...
      2 => AppRoutes.plants.path,
      3 => AppRoutes.settings.path,
